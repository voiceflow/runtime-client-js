...
const createVariableManager = <S extends State['variables']>() => {
    const getState = sinon.stub<void[], InternalAppState | null>();
...
describe('VariableManager', () => {
    ...
    it('get, throws if appState is null', () => {
        ...
        expect(callback).to.throw("VFError: cannot access variables, appState was not initialized");
    });
    ...
    it('getAllKeys', () => {
        ...
        const result: string[] = varManager.getAllKeys();
